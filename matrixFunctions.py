...
def dPdT(V,theta,K,a,y,Y,bsh,isP):
	G = real(copy(Y))
	B = imag(copy(Y))
	g = real(copy(y))
	b = imag(copy(y))
...
def dPdV(V,theta,K,a,y,Y,bsh,isP):
	G = real(copy(Y))
	B = imag(copy(Y))
	g = real(copy(y))
	b = imag(copy(y))
...
def dQdT(V,theta,K,a,y,Y,bsh,isP):
	G = real(copy(Y))
	B = imag(copy(Y))
	g = real(copy(y))
	b = imag(copy(y))
...
def dQdV(V,theta,K,a,y,Y,bsh,isP):
	G = real(copy(Y))
	B = imag(copy(Y))
	g = real(copy(y))
	b = imag(copy(y))
...
def h(V,theta,K,a,y,Y,bsh,isP,isV):
	G = real(copy(Y))
	B = imag(copy(Y))
	g = real(copy(y))
	b = imag(copy(y))
...
def Jac(V,theta,K,a,y,Y,bsh,isP,isV):	
